        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-0 md:p-6">
          ...
          >
            ...
            <div className="text-center mb-4 md:mb-8 shrink-0">
              <h2 className="font-bold text-[#d9ad33] font-serif text-center tracking-[0.3em] uppercase text-lg sm:text-xl md:text-2xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                {t.chooseMode || "CHOOSE MODE"}
              </h2>
              <p className="text-white/40 text-[9px] sm:text-xs font-sans tracking-wider mt-1">
            ...
            <div className="flex flex-col gap-4 md:gap-8 flex-1">
              ...
              <div>
                <div className="flex items-center gap-3 mb-2 sm:mb-4">
                  ...
                  <span className="text-[9px] sm:text-xs text-[#d9ad33] font-bold tracking-[0.2em] uppercase">{t.playNow || "Play Now"}</span>
                  <div className="h-px bg-gradient-to-l from-transparent via-[#d9ad33]/40 to-[#d9ad33]/40 flex-1" />
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-6">
                  {/* Card 1: Versus Computer */}
                  <div className="flex flex-col justify-between p-4 sm:p-5 rounded-2xl bg-gradient-to-b from-[#131118]/80 to-[#0c0a0e]/95 border border-[#d9ad33]/30 shadow-xl relative group overflow-hidden min-h-[140px] sm:min-h-[170px]">
                    <div className="flex gap-3 sm:gap-4 items-start">
                      <div className="w-10 h-10 sm:w-14 sm:h-14 bg-[#d9ad33]/10 border border-[#d9ad33]/20 rounded-xl flex items-center justify-center text-[#d9ad33] shrink-0 shadow-[0_0_15px_rgba(217,173,51,0.15)]">
                        <Crown size={20} className="sm:w-7 sm:h-7" />
                      </div>
                      <div className="text-left">
                        <h3 className="font-bold text-white tracking-wider text-xs sm:text-base">{t.vsComputer || "VERSUS COMPUTER"}</h3>
                        <h4 className="text-[8px] sm:text-[9px] text-[#d9ad33] font-bold tracking-widest uppercase mt-0.5">{t.compCareer || "Comp Career"}</h4>
                        <p className="text-white/60 text-[10px] sm:text-[11px] mt-1 sm:mt-2 leading-relaxed font-sans">
                    ...
                    <div className="mt-3 sm:mt-4">
                      <motion.button
                        ...
                        className="w-full py-2 sm:py-2.5 bg-[#d9ad33] hover:bg-[#f5d666] text-black rounded-xl font-bold tracking-widest uppercase text-[9px] sm:text-[10px] transition-all flex items-center justify-center gap-2 cursor-pointer shadow-lg hover:shadow-[#d9ad33]/20"
                      >
                        <span>{t.playCompCareer || "Play Comp Career"}</span>
                        <span className="text-[10px] sm:text-[12px] font-sans">&gt;</span>
                      </motion.button>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-between p-4 sm:p-5 rounded-2xl bg-gradient-to-b from-[#131118]/80 to-[#0c0a0e]/95 border border-[#d9ad33]/30 shadow-xl relative group overflow-hidden min-h-[140px] sm:min-h-[170px]">
                    <div className="flex gap-3 sm:gap-4 items-start">
                      ...
                      <div className="text-left">
                        <h3 className="font-bold text-white tracking-wider text-xs sm:text-base">{t.vsFriendLocal || "VERSUS FRIEND LOCAL"}</h3>
                        <h4 className="text-[8px] sm:text-[9px] text-[#d9ad33] font-bold tracking-widest uppercase mt-0.5">{t.oneDevice || "One Device"}</h4>
                        <p className="text-white/60 text-[10px] sm:text-[11px] mt-1 sm:mt-2 leading-relaxed font-sans">
